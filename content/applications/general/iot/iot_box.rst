...
- **Red LED lit**: The IoT box is not connected to Internet. Ensure the Ethernet cable is properly
...
- On IoT box images `L2026.05.25` and later, the IoT Box IP address is displayed as a discovered
  Bluetooth device for 5 minutes after the boot.
...
.. tip::
   ...
   - To fully reboot the IoT box, unplug and plug it back in.
