...
For **Point of **Sale** receipts, open your **Point of Sale** app, go to
:menuselection:`Configuration --> Settings`, navigate to the :guilabel:`Bills & Receipts` section,
and enable :guilabel:`Gulf Cooperation Council Format`.
