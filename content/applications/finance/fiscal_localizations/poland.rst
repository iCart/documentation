...
.. tip::
   The Polish Ministry of Finance provides a `video documentation playlist <https://www.youtube.com/watch?v=V6E1fGUFPw4&list=PLGj5OAFBHLKX0cEVGjcGplnbX6LpDFF38&index=1>`_
   on the KSeF platform.
...
Once the certificate request is complete, download the **certificate file (`.pem`)** and save the
...
.. tip::
   KSeF test and pre-production environments are available `here <https://ksef.podatki.gov.pl/aplikacja-podatnika-ksef-20/>`_.
...
#. In the pop-up window, click :guilabel:`Upload your file` and select your **certificate**
   (`.rpm`). In the :guilabel:`Certificate Password` field, enter the password created during the
...
By default, the Polish localization automatically fetches vendor bills from KSeF at regular
intervals. To adjust this frequency or toggle the feature:

#. Activate :doc:`developer mode <../../general/developer_mode>`.
#. Open the **Settings** app.
#. Click the :guilabel:`Technical` menu at the top and select :guilabel:`Automation: Scheduled
   Actions`.
#. Search for and open :guilabel:`5 Polish eInvoice: Download vendor bills from KSeF`.
