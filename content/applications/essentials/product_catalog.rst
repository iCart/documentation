...
The product catalog simplifies the creation of new:
...
selected. It can be accessed from the first tab of the record form, and opens in a new page when
selected. Products and components in the catalog are displayed in a user-friendly, point of
sale-style format. They can be selected from the catalog and added to forms.
...
|BoM|. On the record form, click :guilabel:`Catalog` under the Product line. The required fields
that must be filled out to view the product catalog become highlighted. Fill out the required
fields, then click the :guilabel:`Catalog` link to open the catalog in a new page.
...
- On-hand quantity
- Variant attributes (e.g., colors, materials, customizaztions, etc.)
